...
def train(args):
    ...
    if args.init_from is not None:
        ...
        with file_io.FileIO(os.path.join(args.init_from, 'chars_vocab.pkl'), 'r') as f:
    ...
    with file_io.FileIO(os.path.join(args.save_dir, 'config.pkl'), 'w') as f:
        cPickle.dump(args, f)
    with file_io.FileIO(os.path.join(args.save_dir, 'chars_vocab.pkl'), 'w') as f:
    ...
    with tf.Session() as sess:
        ...
        summary_writer = tf.summary.FileWriter(os.path.join(args.save_dir, 'log'), sess.graph)
        ...
        for e in range(args.num_epochs):
            ...
            for b in range(data_loader.num_batches):
                ...
                feed = {model.data_in: x, model.targets: y, model.state_in: state}
